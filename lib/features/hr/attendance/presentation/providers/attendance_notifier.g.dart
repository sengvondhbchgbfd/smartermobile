...
final staffAttendanceProvider =
    ...
    >.internal(
      StaffAttendance.new,
      name: r'staffAttendanceProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$staffAttendanceHash,
      dependencies: null,
...
final scanAttendanceProvider =
    ...
    >.internal(
      ScanAttendance.new,
      name: r'scanAttendanceProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$scanAttendanceHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
final attendanceSettingsProvider =
    ...
    >.internal(
      ...
      name: r'attendanceSettingsProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$attendanceSettingsHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
final managerAttendanceProvider =
    AutoDisposeAsyncNotifierProvider<
      ManagerAttendance,
      ManagerAttendanceState
    >.internal(
      ManagerAttendance.new,
      name: r'managerAttendanceProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$managerAttendanceHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );

typedef _$ManagerAttendance = AutoDisposeAsyncNotifier<ManagerAttendanceState>;
